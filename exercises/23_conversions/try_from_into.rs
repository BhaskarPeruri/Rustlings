...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let red: u8 = slice[0].try_into().or(Err(IntoColorError::IntConversion))?;
        let green: u8 = slice[1].try_into().or(Err(IntoColorError::IntConversion))?;
        let blue: u8 = slice[2].try_into().or(Err(IntoColorError::IntConversion))?;
        Ok(Color{red, green, blue})     
